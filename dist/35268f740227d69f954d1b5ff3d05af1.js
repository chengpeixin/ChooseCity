...
!function (t, i) {
  ...
  function f(t, i, e, s, o, n) {
    var r = t - i,
        ...
        d = p ? 4 : 15,
        f = t + h / a * (r < 0 ? -1 : 1);
    return p && l && (f = Math.round(f / l) * l), f < s ? (f = o ? Math.max(s - o / 4, s - o / d * h) : s, u = c) : f > 0 && (f = o ? Math.min(o / 4, o / d * h) : 0, u = c), {
  ...
  return w.prototype.handleEvent = function (t) {
    ...
    i.prototype._start = function (i) {
      ...
      if (this.enabled && !this.destroyed && z[i.type] === this.initiated) {
        this.initiated = !1, this.options.preventDefault && !a(i.target, this.options.preventDefaultException) && i.preventDefault(), this.options.stopPropagation && i.stopPropagation(), this.trigger("touchEnd", {
          x: this.x,
          y: this.y
        ...
        if (this.directionX = o > 0 ? N : o < 0 ? B : 0, this.directionY = n > 0 ? U : n < 0 ? R : 0, !this.options.pullDownRefresh || !this._checkPullDown()) if (this._checkClick(i)) this.trigger("scrollCancel");else if (!this.resetPosition(this.options.bounceTime, A.bounce)) {
          ...
          if (this._events.flick && r < this.options.flickLimitTime && h < this.options.flickLimitDistance && l < this.options.flickLimitDistance) this.trigger("flick");else {
            ...
            if (this.options.momentum && r < this.options.momentumLimitTime && (l > this.options.momentumLimitDistance || h > this.options.momentumLimitDistance)) {
              var p = this.hasHorizontalScroll ? f(this.x, this.startX, r, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options) : {
                destination: e,
                duration: 0
              },
                  u = this.hasVerticalScroll ? f(this.y, this.startY, r, this.maxScrollY, this.options.bounce ? this.wrapperHeight : 0, this.options) : {
                destination: s,
                duration: 0
              };
      ...
      t.target === this.scroller && this.isInTransition && (this._transitionTime(), this.pulling || this.resetPosition(this.options.bounceTime, A.bounce) || (this.isInTransition = !1, this.options.probeType !== q && this.trigger("scrollEnd", {
        x: this.x,
        y: this.y
      })));
      ...
      function n() {
        ...
        var u = o(p = (p - l) / s),
            d = (i - h) * u + h,
            f = (e - a) * u + a;
        r._translate(d, f), r.isAnimating && (r.animateTimer = I(n)), r.options.probeType === q && r.trigger("scroll", {
          x: r.x,
          y: r.y
        });
      }
      ...
      var t = window.getComputedStyle(this.scroller, null),
          i = void 0,
          e = void 0;
      return this.options.useTransform ? (i = +((t = t[O.transform].split(")")[0].split(", "))[12] || t[4]), e = +(t[13] || t[5])) : (i = +t.left.replace(/[^-\d.]/g, ""), e = +t.top.replace(/[^-\d.]/g, "")), {
        x: i,
        y: e
      };
    ...
    t.prototype._initSnap = function () {
      ...
      "string" == typeof s && (s = this.scroller.querySelectorAll(s)), this.on("refresh", function () {
        if (t.pages = [], t.wrapperWidth && t.wrapperHeight && t.scrollerWidth && t.scrollerHeight) {
          ...
          if (s) for (p = s.length, d = -1; c < p; c++) {
            f = h(s[c]), (0 === c || f.left <= h(s[c - 1]).left) && (u = 0, d++), t.pages[u] || (t.pages[u] = []), n = Math.max(-f.left, t.maxScrollX), r = Math.max(-f.top, t.maxScrollY), a = n - Math.round(f.width / 2), l = r - Math.round(f.height / 2), t.pages[u][d] = {
              x: n,
              y: r,
              width: f.width,
              height: f.height,
      ...
      var t = this.options.snap;
      return t ? t.loop ? t._loopX ? i({}, this.currentPage, {
    ...
    t.prototype._initScrollbar = function () {
      ...
      this.options.scrollX && (r = {
        ...
        fade: s,
        interactive: n
      }, this._insertScrollBar(r.el), this.indicators.push(new w(this, r))), this.options.scrollY && (r = {
        el: y("vertical"),
        direction: "vertical",
        fade: s,
        interactive: n
      }, this._insertScrollBar(r.el), this.indicators.push(new w(this, r))), this.on("refresh", function () {
...
var _dataList = require("./../data/dataList.json");
...
var init = function init() {
  ...
  var scroll = new _scroll2.default(wrapper, {
    scrollY: true,
    scrollX: true,
    probeType: 3
  });
  var str = "<li class=\"li\">\u9ED8\u8BA4\u57CE\u5E02</li>";
  var str2 = "";
  ...
  // await
  _dataList2.default.map(function (item) {
  ...
  var anchor_nav_list = document.querySelectorAll('.anchor_navi_tem');
  // await
  anchor.forEach(function (v, i) {
    TITLE_TOP.push({
      el: v,
      offTop: v.offsetTop,
  ...
  // await
  var anchor_tile = document.querySelector('#title');
  // async
  scroll.on("scroll", function (pos) {
    var y = pos.y,
        x = pos.x;
    for (var i = 0; i < TITLE_TOP.length - 1; i++) {
      var item = TITLE_TOP[i];
      var height1 = item.offTop;
      var height2 = TITLE_TOP[i + 1].offTop;
      if (-y >= height1 && -y < height2) {
        ...
        anchor_nav_list.forEach(function (item) {
...
window.onload = init();
},{"./../less/index.less":3,"./scroll":5,"./../data/dataList.json":4}]},{},[2])
//# sourceMappingURL=/dist/35268f740227d69f954d1b5ff3d05af1.map